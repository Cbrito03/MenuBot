var colas = {
  ...
  "cotizar" :
  {
    "1" : "GT_FB_MSS_Ventas_MO",
    "2" : "GT_FB_MSS_Ventas_FI"
  },
  "estado" :
  {
    "1" : "GT_FB_MSS_Ventas_MO",
...
var menu_opciones_asesor = // pendiente las colas
{
  ...
  "2": {
    "action" : {
      "type" : "transfer",
      "queue" : colas.asesor["2"] // GT_FB_MSS_Ventas_FI
    },
    "messages" : [
      /*{
        "type" : "text",
...
var menu_opciones_datos = // pendiente las colas
{
  ...
  "2": {
    "action" : {
      "type" : "transfer",
      "queue" : colas.datos["2"] // GT_FB_MSS_Ventas_FI
    },
    "messages" : [
      /*{
        "type" : "text",
...
var menu_opciones_cotizar = 
{
  ...
  "2": {
    "action" : {
      "type" : "transfer",
      "queue" : colas.cotizar["2"] // GT_FB_MSS_Ventas_FI
    },
    "messages" : [
      /*{
        "type" : "text",
...
var menu_opciones_estado = 
{
  ...
  "2": {
    "action" : {
      "type" : "transfer",
      "queue" : colas.estado["2"] // GT_FB_MSS_Ventas_FI
    },
    "messages" : [
      /*{
        "type" : "text",
